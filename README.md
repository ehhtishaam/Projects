...
This is where I keep the stuff I build — university projects and self-directed ones, mostly Python, Java, and C++, some just for practice, some because I wanted to understand how something actually works under the hood.
...
## 🛠️ Standards
Every project folder has the full source code plus its own README explaining what it does, what I used to build it, and what I actually learned from it.
Everything here is my own code and writing — no copied course material.
